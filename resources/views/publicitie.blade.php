        ...
        <tbody>
            ...
            @foreach ($publicities as $publicitie)
                <tr>
                    ...
                    <td>{{ $publicitie->nombre }}</td>
                </tr>
                <td>
                    <form action="{{ route('publicitie.DeletePublicitie', $publicitie->id) }}" method="get" style="display: inline-block"> @csrf
                        <button type="submit">Borrar</button>
                    </form>
                </td>
                <td>
                    <form action="{{ route('publicitie.RedirectPageToEditPublicitie', $publicitie->id) }}" method="get" style="display: inline-block"> @csrf
